...
class EnrollmentsControllerTest < ActionController::TestCase
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post :create, enrollment: { fee: @enrollment.fee, grade: @enrollment.grade, involvement: @enrollment.involvement }
    end
  ...
  test "should update enrollment" do
    put :update, id: @enrollment, enrollment: { fee: @enrollment.fee, grade: @enrollment.grade, involvement: @enrollment.involvement }
    assert_redirected_to enrollment_path(assigns(:enrollment))
  end
