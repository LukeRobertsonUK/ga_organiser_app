...
class AnnouncementsControllerTest < ActionController::TestCase
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post :create, announcement: { announcement_image: @announcement.announcement_image, announcement_text: @announcement.announcement_text }
    end
  ...
  test "should update announcement" do
    put :update, id: @announcement, announcement: { announcement_image: @announcement.announcement_image, announcement_text: @announcement.announcement_text }
    assert_redirected_to announcement_path(assigns(:announcement))
  end
