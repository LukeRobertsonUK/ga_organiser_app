...
class CampusControllerTest < ActionController::TestCase
  ...
  test "should create campu" do
    assert_difference('Campu.count') do
      post :create, campu: { address: @campu.address, campus_image: @campu.campus_image, directions: @campu.directions, name: @campu.name, telephone: @campu.telephone }
    end
  ...
  test "should update campu" do
    put :update, id: @campu, campu: { address: @campu.address, campus_image: @campu.campus_image, directions: @campu.directions, name: @campu.name, telephone: @campu.telephone }
    assert_redirected_to campu_path(assigns(:campu))
  end
